...
php_start(0);
	...
	class PPDF extends FPDF{
		...
		function Header(){
			...
			global $title,$title2,$title3,$titulo,$logo,$idioma;
			$fecha=date("d-m-Y");
			
			$this->Image(dirname(__FILE__)."/../imagenes/logos/".$logo,10,10,20,20);
			$this->Fuente("",10);
			$this->SetXY(34,11);
			$this->Cell(55,4,utf8_decode($title),0,0,"C");
			$this->Fuente("B",10);
			$this->SetXY(34,15);
			$this->Cell(55,4,utf8_decode($title2),0,0,"C");
			$this->Fuente("",10);
			$this->SetXY(34,19);
			$this->Cell(55,4,utf8_decode($title3),0,0,"C");
			$this->ln(10);	
			$this->Fuente("B",18);
