...
$pdf->CuadroCuerpoPersonalizado(140,$usu4['grado']." ".$usu4['nombre']." ".$usu4['paterno']." ".$usu4['materno'],0,"C",0,"B");
$pdf->CuadroCuerpoPersonalizado(140,$usu3['grado']." ".$usu3['nombre']." ".$usu3['paterno']." ".$usu3['materno'],0,"C",0,"B");
$pdf->ln();
$pdf->CuadroCuerpo(140,$usu4['cargo'],0,"C",0);
$pdf->CuadroCuerpo(140,$usu3['cargo'],0,"C",0);
$pdf->ln();$pdf->ln();$pdf->ln();$pdf->ln();$pdf->ln();$pdf->ln();
$pdf->CuadroCuerpoPersonalizado(280,$usu2['grado']." ".$usu2['nombre']." ".$usu2['paterno']." ".$usu2['materno'],0,"C",0,"B");
$pdf->ln();
$pdf->CuadroCuerpo(280,$usu2['cargo'],0,"C",0);
$pdf->Output();
?>